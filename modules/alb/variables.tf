...
variable "lb_https_listener_rules" {
...
variable "lb_listener_ssl_policy_default" {
...
variable "lb_load_balancer_create_timeout" {
  description = "Timeout value when creating the ALB."
  type        = string
  default     = "20m"
}

variable "lb_load_balancer_delete_timeout" {
...
variable "lb_load_balancer_update_timeout" {
