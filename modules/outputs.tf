...
output "lb_http_tcp_listener_ids" {
...
output "lb_target_group_attachments" {
  description = "ARNs of the target group attachment IDs."
  value = {
    for k, v in aws_lb_target_group_attachment.lb_asssign_tg : k => v.id
  }
}